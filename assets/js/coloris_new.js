                ...
                switch (e) {
                    ...
                    case "theme":
                        t.theme && (C.theme = t.theme),
                            (f.className = "clr-picker clr-" + C.theme + " clr-" + C.themeMode),
                            C.inline && j();
                        break;
                    case "rtl":
                        (C.rtl = !!t.rtl),
                    ...
                    case "clearButton":
                        "object" == typeof t.clearButton &&
                            (t.clearButton.label &&
                                ((C.clearLabel = t.clearButton.label), (v.innerHTML = C.clearLabel)),
    ...
    function I(e) {
        C.inline ||
            ...
            (C.focusInput || C.selectInput) &&
                (y.focus({ preventScroll: !0 }), y.setSelectionRange(L.selectionStart, L.selectionEnd)),
    ...
    function z(e, t) {
        ...
        var n,
            o = (function (e) {
                ...
                C.alpha &&
                    (e.a < 1 || C.forceAlpha) &&
                    ((e = (255 * e.a) | 0), (r = e.toString(16)), e < 16 && (r = "0" + r));
                return "#" + t + a + l + r;
            })(x),
            c = o.substring(0, 7);
        switch (
